...
1. Distribute those portions of the SDK that are identified
...
1. The distributable portions of the SDK shall only be
 accessed by your application.
1. The following notice shall be included in modifications
 and derivative works of sample source code distributed:
 “This software contains source code provided by NVIDIA
 Corporation.”
1. Unless a developer tool is identified in this Agreement
 as distributable, it is delivered for your internal use
 only.
1. The terms under which you distribute your application
...
1. You agree to notify NVIDIA in writing of any known or
...
1. Except as expressly provided in this Agreement, you may
 not copy, sell, rent, sublicense, transfer, distribute,
 modify, or create derivative works of any portion of the
 SDK. For clarity, you may not distribute or sublicense the
 SDK as a stand-alone product.
1. Unless you have an agreement with NVIDIA for this
 purpose, you may not indicate that an application created
 with the SDK is sponsored or endorsed by NVIDIA.
1. You may not bypass, disable, or circumvent any
 encryption, security, digital rights management or
 authentication mechanism in the SDK.
1. You may not use the SDK in any manner that would cause it
...
1.  You acknowledge that the SDK as delivered is not tested
 ...
 requirements.
1.  You agree to defend, indemnify and hold harmless NVIDIA
...
1.  You hold all rights, title and interest in and to your
 applications and your derivative works of the sample
 source code delivered in the SDK, including their
 respective intellectual property rights, subject to
 NVIDIA’s rights under Section 1.3.1.
1. You may, but don’t have to, provide to NVIDIA
...
1. If you want to terminate this Agreement, you may do so by
 stopping to use the SDK.
1. NVIDIA may, at any time, terminate this Agreement if:
...
2. Upon any termination of this Agreement, you agree to
